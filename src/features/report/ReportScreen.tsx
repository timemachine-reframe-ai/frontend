    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-4">
        <div className="bg-white/80 backdrop-blur-xl border border-white/60 p-12 rounded-[2.5rem] shadow-2xl shadow-slate-200/50 animate-fade-in max-w-lg mx-auto relative overflow-hidden">
          ...
          <div
            className="absolute bottom-0 left-0 w-32 h-32 bg-secondary-100/50 rounded-full blur-2xl -ml-8 -mb-8 animate-pulse pointer-events-none"
          ...
          <div className="relative z-10 flex flex-col items-center">
            <div className="w-24 h-24 relative mb-8">
              ...
              <div className="absolute top-1/2 -right-6 text-xl animate-pulse">
                ✨
              </div>
            </div>
    ...
    <div className="bg-white/80 backdrop-blur-xl border border-white/60 p-8 md:p-12 rounded-[2.5rem] shadow-2xl shadow-slate-200/50 animate-fade-in max-w-4xl mx-auto relative overflow-hidden">
      ...
      <div className="relative text-center mb-12">
        ...
        <p className="text-lg text-slate-500 max-w-xl mx-auto leading-relaxed">
          ...
          <span className="text-primary-700 font-bold">감정 흐름</span>과{" "}
          <span className="text-secondary-700 font-bold">핵심 인사이트</span>
          입니다.
        </p>
      </div>
        ...
        {report.counselorAdvice && (
          <section className="bg-gradient-to-br from-sky-50 to-white border border-sky-100 p-8 rounded-[2rem] shadow-sm hover:shadow-md transition-shadow duration-300">
            ...
            <div className="bg-white border border-sky-100/50 p-6 rounded-2xl shadow-sm">
              <p className="text-sky-700 leading-relaxed text-lg whitespace-pre-line">
                {report.counselorAdvice}
              </p>
            </div>
            {report.encouragement && (
              <div className="mt-4 bg-gradient-to-r from-sky-100 to-blue-100 p-4 rounded-xl border border-sky-200">
                <p className="text-sky-800 font-medium italic flex items-center gap-2">
            ...
            {report.suggestedPhrases.length ? (
              <div className="space-y-4">
                {report.suggestedPhrases.map((phrase, i) => (
                  <div
                    key={i}
                    className="bg-white border border-emerald-100/50 p-4 rounded-xl shadow-sm"
                  >
                    <p className="text-emerald-700 italic font-medium leading-relaxed">
                      "{phrase}"
                    </p>
                  </div>
                ))}
